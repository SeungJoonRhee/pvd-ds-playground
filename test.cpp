...
// Libraries for btree example
#include <absl/container/btree_map.h>

// Libraries for rtree example
...
int rtree_example()
{
    // Following code is taken from https://www.boost.org/doc/libs/1_83_0/libs/geometry/doc/html/geometry/spatial_indexes/rtree_examples/quick_start.html
...
int main()
{
    ...
    btree_example();
    std::cout << "---R Tree Example---" << std::endl;
    rtree_example();
}